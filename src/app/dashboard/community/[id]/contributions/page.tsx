  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">{community?.name} - Contributions</h1>
          <p className="text-muted-foreground">Manage group contributions</p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href={`/dashboard/community/${communityId}`}>Back to Group</Link>
          </Button>
          <Dialog>
