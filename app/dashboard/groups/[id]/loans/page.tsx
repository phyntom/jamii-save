    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">${Number(loanStats.total_disbursed).toFixed(2)}</div>
          </CardContent>
        </Card>
      </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1 space-y-1">
                        ...
                        <p className="text-xs text-muted-foreground">
                          {new Date(loan.created_at).toLocaleDateString()} • {loan.repayment_months} months •{" "}
