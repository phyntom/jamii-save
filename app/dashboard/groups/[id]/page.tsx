    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${Number(groupStats.total_contributions).toFixed(2)}</div>
            <p className="text-xs text-muted-foreground">{groupStats.contribution_count} contributions</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">${Number(group.contribution_amount).toFixed(2)}</div>
