      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input id="phone" type="tel" defaultValue={userInfo.phone_number || ""} placeholder="Not set" disabled />
          </div>
            ...
            <>
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground capitalize">{subscription[0].billing_cycle} billing</p>
                </div>
